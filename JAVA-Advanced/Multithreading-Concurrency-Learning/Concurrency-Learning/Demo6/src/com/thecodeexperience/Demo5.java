...
import com.thecodeexperience.service.impl.CounterServiceImpl4;
...
public class Demo5 extends Thread {
	...
	public Demo5(CounterService counterService) {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		do {
			...
			counterService = new CounterServiceImpl4();
			for (int i = 0; i < NUM_THREADS; ++i) {
				threads[i] = new Demo5(counterService);
				threads[i].start();
			}
			for (int i = 0; i < NUM_THREADS; ++i) {
				threads[i].join();
